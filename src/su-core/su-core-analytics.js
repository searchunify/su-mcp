...
const baseReportTypes = {
  ...
  /** POST /api/v2/leadership/deflection-cost-savings-download — CSV / email export (requires analytics-secret via admin). */
